...
describe("ContextInspector interactions", () => {
  test("inspects the selected message by executionId without substituting the current next model", async () => {
    ...
    const session: Session = {
      ...
      agentName: "engineer", activeSkillNames: [], ...modelState, pendingMessages: [], steps: [], todos: [], reminders: [], childSessionLinks: [], childResultReceipts: [], stats: createEmptySessionStats(),
  ...
  test("organizes Session agents, changed files, and context from real APIs", async () => {
    ...
    const session: Session = {
      ...
      createdAt: 1, updatedAt: 2, agentName: "engineer", activeSkillNames: [], ...modelState, messages: [], pendingMessages: [], steps: [], todos: [], reminders: [], childSessionLinks: [], childResultReceipts: [], executions: [], stats: createEmptySessionStats(),
    };
