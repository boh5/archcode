...
export function ConfigRecoverySettings({
  ...
  return <div className="min-h-dvh bg-bg-base p-0 text-text-primary sm:p-4">
    <section aria-label="Configuration recovery settings" className="mx-auto h-dvh min-h-0 w-full overflow-hidden border-border-strong bg-bg-overlay sm:h-[calc(100dvh-32px)] sm:max-w-[1120px] sm:rounded-[var(--shape-dialog)] sm:border">
