...
function createTestRuntime(projectRegistry: ProjectRegistry) {
  ...
  const runtime = {
    ...
    startSessionExecution: () => { throw new Error("not implemented"); },
    ...
    listLoops: async () => [],
    readLoop: async () => { throw new Error("not implemented"); },
    createLoop: async () => { throw new Error("not implemented"); },
    updateLoop: async () => { throw new Error("not implemented"); },
    pauseLoop: async () => { throw new Error("not implemented"); },
    resumeLoop: async () => { throw new Error("not implemented"); },
    ...
    readLoopCollisions: async () => ({ targets: [], activeLeases: [], conflicts: [], updatedAt: 0 }),
    readLoopIntegrationStatus: async () => ({ statuses: [], snapshot: null, updatedAt: 0 }),
    readLoopRunLog: async () => [],
