...
export interface SessionGoalDelegationAdmission {
  run<T>(input: SessionGoalDelegationAdmissionInput, action: () => Promise<T>): Promise<T>;
}
...
export class RoleDrivenSessionGoalDelegationAdmission implements SessionGoalDelegationAdmission {
  ...
  async run<T>(input: SessionGoalDelegationAdmissionInput, action: () => Promise<T>): Promise<T> {
