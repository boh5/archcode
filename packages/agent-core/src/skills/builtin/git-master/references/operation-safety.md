...
| Branch/PR preparation | base-to-HEAD committed diff, worktree state, checks, upstream | publication, push, base, or destructive cleanup was not requested |
...
For branch or PR readiness, review the base-to-HEAD committed diff. Separately inspect `git_status`, staged and unstaged diffs, and relevant untracked files; none of those are included in base-to-HEAD history.
